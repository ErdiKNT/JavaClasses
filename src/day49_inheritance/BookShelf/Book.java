package day49_inheritance.BookShelf;
...
public class Book {
    ...
    public static String capitalize(String word) {
        if (word.isEmpty()) {
            ...
            word = word.substring(0, 1).toUpperCase() + word.substring(1, word.indexOf(" ")).toLowerCase() + " "
                    + word.substring(word.indexOf(" ") + 1, word.indexOf(" ") + 2).toUpperCase() + word.substring(word.indexOf(" ") + 2);
    ...
    public static boolean isTitleWord(String word) {
        ...
        if (word.equals("a") || word.equals("an") || word.equals("the")) {
            return false;
        } else if (word.equals("and") || word.equals("but") || word.equals("for") || word.equals("nor") || word.equals("or") || word.equals("so") ||
                word.equals("yet")) {
            return false;
        } else if (word.equals("at") || word.equals("by") || word.equals("in") || word.equals("into") || word.equals("near") || word.equals("of") ||
                word.equals("on") ||
                word.equals("to") || word.equals("than") || word.equals("via")) {
            return false;
        } else {
            return true;
        }
