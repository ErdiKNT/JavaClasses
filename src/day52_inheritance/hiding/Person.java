...
class SecretIdentity extends Person {
    ...
    String name = "DNOB SEMAJ"; // we created another name variable in the subclass, but it was already being inherited, so now we are hiding the one from the parent
