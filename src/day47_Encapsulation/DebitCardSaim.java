...
public class DebitCardSaim {
    ...
    */
    ...
    public DebitCardSaim(long cardNumber, String holderName, double balance){
    ...
    public DebitCardSaim(long cardNumber, String holderName, String cardType, int pin, double balance) {
