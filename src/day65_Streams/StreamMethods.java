...
public class StreamMethods {
    public static void main(String[] args) {
        ...
        List<Integer> list2 = new ArrayList<>(Arrays.asList(1,1,2,2,2,4,4,5,5,6,1,1,2,2));
        ...
        /*
          ...
          .collect((Collectors.toList()) converts the stream back to a list ==> This help us to print our list.

          list2 = list2.stream().distinct().collect(Collectors.toList()) ==> Reassigning is fine
         */

        System.out.println("Original List: "+list2); // This one gives us original list. (Without remove duplicates)
